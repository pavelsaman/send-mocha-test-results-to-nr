...
.PHONY: install install-git-hooks format lint format-and-lint lint-format-check build package all clean clean-all dist-check
...
lint-format-check:
	$(SAY) "Lint and format check in progress..."
	@npm run lint-check
